...
parser.add_argument('--data', type=str, default='custom', help='data') # custom
parser.add_argument('--root_path', type=str, default='./data/KDD99/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='KDDTX.csv', help='data file')
# parser.add_argument('--model', type=str,default='informer',help='model of experiment, options: [informer, informerstack, informerlight(TBD)]')
...
data_parser = {
    ...
    'custom':{'data':'KDDTX.csv','T':'AO','M':[40,40,40],'S':[1,1,1],'MS':[40,40,1]},
}
